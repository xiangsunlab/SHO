...
void NAIVE2NM();
void NM2NAIVE();
void NM_Momenta(Real dt); //Analytical propagation
...
vector<Real> nmP;
vector<Real> nmF;
vector<Real> omega;    //Normal Mode eigenvalue of frequency
vector<Real> fric;    //Normal Mode friction
vector<Real> eva00;    //Normal Mode Propagation Posi Posi
vector<Real> eva01;    //Normal Mode Propagation Posi Mome
vector<Real> eva10;    //Normal Mode Propagation Mome Posi
vector<Real> eva11;    //Normal Mode Propagation Mome Posi
vector<Real> Uni;    //Unitary Matrix to diagonalise the matrix
vector<Real> UT;     //Transpose Matrix of Unitary Matrix
vector<Real> c1;
vector<Real> c2;
